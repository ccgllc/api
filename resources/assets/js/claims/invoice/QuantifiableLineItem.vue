	...
	<LineItemBase :lineItem="lineItem">
		<template #data>
			<div class="control">
			 ...
			 <div class="control has-icons-left" v-if="lineItem.has('quantity')" style="width: 11.5%;">
			...
			<div class="control has-icons-left" style="width: 11.5%">
				<div class="select"
		    ...
		    <input v-else class="input" placeholder="rate" v-model="lineItem.rate" type="text" @change="update()" :disabled="lineItem.type == 'amount' || !lineItem.has('name')" :readonly="!lineItem.has('name')">
		   <span class="icon is-small is-left has-text-bold">
				<small>rate</small>
		   </span>
			</div>
