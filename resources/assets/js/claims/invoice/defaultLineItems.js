export default {
	grossLoss: {type: 'ServiceFeeLineItem', description: 'Service Fee', amount: 'default', total: 0, taxable: true, fullyReimbursable: false, feeSchedule: {}, id: 1},
	...
	adminFee: {type: 'AdminFeeLineItem', description: 'Administrative Fee', amount: 0, minimum: 0, total: 0, taxable: true, fullyReimbursable: false },
	surcharge: {type: 'CitySurchargeLineItem', description: 'Surcharge (10% of Service Fee)', amount: 0, minimum: 0, total: 0, taxable: true, fullyReimbursable: false }
}