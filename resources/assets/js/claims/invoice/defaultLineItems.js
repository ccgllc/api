export default {
	...
	hours: {type: 'HourlyRateLineItem', description: 'Time & Expense Hours', quantity: 0, rate: 0, total: 0, taxable: false, fullyReimbursable: false },
	mileage: {type: 'QuantifiableLineItem', description: 'Mileage', quantity: 0, rate: 0, minimum: 0, total: 0, taxable: false, fullyReimbursable: true, locations: {start: '', loss: '' }},
