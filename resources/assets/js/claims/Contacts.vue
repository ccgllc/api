					...
					<div class="content">
						<div class="columns">
		    				...
		    				<div class="column">
								...
								<h1 class="title" style="font-size: 2em; font-weight: 700; color:#499BE8">{{ ucwords(claim.claim_data.client['name']) }}</h1>
		    				...
		    				<div class="column">
		    					<div v-if="claim.claim_data.accessContact">
			    					<h3 class="subtitle" style="color: #aaa; font-size: .8em;" v-if="claim.claim_data.accessContact.name">Access Contact</h3>
										<!-- <dt>Name:</dt> -->
										<h2 class="title" style="font-size: 2rem;" v-if="claim.claim_data.accessContact.name">{{ claim.claim_data.accessContact.name }}</h2>
