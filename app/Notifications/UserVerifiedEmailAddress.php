...
class UserVerifiedEmailAddress extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMicrosoftTeams($notifiable)
    {
        return MicrosoftTeamsMessage::create()
            ...
            ->content($this->user->name .' just verified their email address ' . $this->user->email . '. We will notify you once more when they complete their profile.')
