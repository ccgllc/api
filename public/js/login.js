...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Login_vue__ = __webpack_require__(576);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	data: function data() {
		return {
			form: new __WEBPACK_IMPORTED_MODULE_1__structur_src_form_Form_js__["a" /* default */]({
				email: "",
				password: "",
				remember: false
			})
				...
				return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 7:
								return _context.abrupt('return', window.location.href = response.destination);
